@extends('dashboard.dash',['title' => 'Historial de facturas'])
...
<div class="row m-0 p-0">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form method="post" class="form-inline" action="{{route('dashboard.gethistorial')}}">
                        {{csrf_field()}}
                        <style>
    ...
    <table class="table m-1">
        <thead>
            <tr class="text-center">
                <th scope="col"> Serial factura </th>
                     ...
                     <div class="btn-group dropleft" id="opciones">
                        ...
                        <div class="dropdown-menu p-0 m-0 rounded">
                            @if (auth()->user()->role == 'ROLE_ADM')
                                ...
                                href="{{route('dashboard.delhistorial',[
                            ...
                            href="{{route('dashboard.dethistorial',['factura_id' => $factura->id, 'modo'=>'NORMAL'])}}">
