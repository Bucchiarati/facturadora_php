@extends('dashboard.dash', ['title'=>'Notas de Entrega/Clientes'])
@section('canvas')
    <div class="row m-0">
            ...
            <div class="row m-0">
                <div class="col-12 my-2">
                    <form method="post" class="form-inline" action="{{route('dashboard.bscCliente')}}">
                        ...
                        <div class="form-group ml-1">
                            <a class="btn btn-secondary btn-block" href="{{route('dashboard.facturar')}}"> 
                                Limpiar Busqueda 
                            </a>
                        </div>
                    </form>
                ...
                <table class="table">
                    ...
                    @foreach($clientes as $cliente)
                        <tr>
                            ...
                            <td>
                                <a class="font-weight-bold text-center dropdown-item border-bottom border-white"
                                   href="{{route('dashboard.facturar_Admin',['id' => $cliente->id])}}">
